...
public class Bid {
    ...
    public Bid(String status, String advertId, String giveBidUserId,String receiveBidUserId, String nameSurname, String fromCity,
        ...
        this.giveBidUserId = giveBidUserId;
        this.receiveBidUserId=receiveBidUserId;
    ...
    public String getGiveBidUserId() {
        return giveBidUserId;
    }

    public void setGiveBidUserId(String giveBidUserId) {
        this.giveBidUserId = giveBidUserId;
    }
    ...
    public String getReceiveBidUserId() {
        return receiveBidUserId;
    }

    public void setReceiveBidUserId(String receiveBidUserId) {
        this.receiveBidUserId = receiveBidUserId;
    }
}
